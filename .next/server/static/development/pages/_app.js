...
class MyMobxApp extends next_app__WEBPACK_IMPORTED_MODULE_2___default.a {
  constructor(...args) {
    super(...args);
    this.state = {
      store: new _store__WEBPACK_IMPORTED_MODULE_4__["Store"]() // Fetching serialized(JSON) store state
  ...
  static async getInitialProps(appContext) {
    ...
    const initialStoreState = await Object(_store__WEBPACK_IMPORTED_MODULE_4__["fetchInitialStoreState"])();
  ...
  render() {
    ...
    return __jsx(mobx_react__WEBPACK_IMPORTED_MODULE_5__["Provider"], {
...
let Store = (_class = (_temp = class Store {
  ...
  hydrate(serializedStore) {
    this.lastUpdate = serializedStore.lastUpdate != null ? serializedStore.lastUpdate : _babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_0___default()();
...
}), _descriptor3 = Object(_babel_runtime_corejs2_helpers_esm_applyDecoratedDescriptor__WEBPACK_IMPORTED_MODULE_2__["default"])(_class.prototype, "start", [mobx__WEBPACK_IMPORTED_MODULE_4__["action"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
    return () => {
      this.timer = setInterval(() => {
        this.lastUpdate = _babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_0___default()();
        this.light = true;
      }, 1000);
    };
  }
})), _class);
async function fetchInitialStoreState() {
